...
const Home = () => {
    ...
    return (
        <>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container">
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <Link className="navbar-brand" to="#how-it-works">
                            <li class="nav-item">
                                <a class="nav-link" href="">¿Cómo funcionamos?</a>
                            </li>
                        </Link>
            ...
            <div class="jumbotron text-center mt-3 container-md main-presentation">
            ...
            <div id="carouselExampleControls" class="carousel container-lg mt-3" data-ride="carousel">
            ...
            <div id="how-it-works"class="jumbotron jumbotron-fluid mb-0 container-md rounded">
                <div class="container">
