            ...
            <form class="container-md">
                ...
                <fieldset class="form-group">
                    ...
                    <div class="form-check">
                        <input id="instructions" class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked />
                        <label id="instructions" class="form-check-label" for="gridRadios1" />Cambiar producto
                </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked />
                        <label id="instructions" class="form-check-label" for="gridRadios1" />Devolver producto
                </div>
                </fieldset>
                <div class="pb-3"></div>
                ...
                <a href="petitions_3" type="button" class="btn btn-dark w-auto">Siguiente</a>
            </form>
